...
{
    public class PokerPlayerTestParseGameState
    {
        [Test]
        public void ParseGameState_ReturnsParsed()
        {
            var gameState = JObject.Parse(SomeGameState);
        ...
        private static readonly GameState ExpectedState = new GameState
        {
            ...
            {
                new Player {Id = 0, Name = "Albert", Status = "active", Stack = 1010, Bet = 320},
                new Player
                {
                    Id = 1, Name = "Bob", Status = "active", Stack = 1590, Bet = 80, Cards = new List<Card>
                    {
                        new Card {Rank = "6", Suit = "hearts"},
                        new Card {Rank = "K", Suit = "spades"},
                    }
                },
                new Player {Id = 2, Name = "Chuck", Status = "out", Stack = 0, Bet = 0}
            },
            CommunityCards = new List<Card>
            {
                new Card {Rank = "4", Suit = "spades"},
                new Card {Rank = "A", Suit = "hearts"},
                new Card {Rank = "6", Suit = "clubs"}
            }
        };

        private const string SomeGameState = @"
{
